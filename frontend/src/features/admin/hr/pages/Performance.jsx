...
export default function Performance({
  ...
  const cards = [
    {
      title: "Review Cycle",
      value: overview.reviewCycle ?? "Quarterly",
      icon: FiTarget,
      color: "bg-blue-500",
    },
    {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-2xl bg-white shadow-sm p-6 flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-500">
            Goals, KPIs, reviews and employee growth.
          </p>
        </div>
        ...
        <table className="w-full">
          ...
          <thead className="bg-gray-100">
            <tr>
              ...
              <th className="p-4 text-left">Review Period</th>
          ...
          <tbody>
            {reviews.map((review) => (
              <tr
                ...
                className="border-t"
              >
                <td className="p-4">{review.employee}</td>
                <td className="p-4">{review.department}</td>
                <td className="p-4">{review.period}</td>
      ...
      <div className="rounded-2xl border border-dashed p-10 text-center text-gray-500">
        KPIs • OKRs • Review History • Promotion Recommendations • Performance Trends
      </div>
