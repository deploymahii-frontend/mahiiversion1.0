  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-2xl bg-white shadow-sm p-6 flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-500">
            Generate operational, financial, and compliance reports.
          </p>
        </div>
              ...
              <tr key={report.id} className="border-t">
                ...
                <td className="p-4">
                  <div className="flex gap-2">
                    <button onClick={() => onView?.(report)} className="rounded border p-2">
                      <FiEye />
                    </button>

                    <button onClick={() => onExport?.(report)} className="rounded border p-2">
                      <FiFileText />
                    </button>
                  </div>
                </td>
      ...
      <div className="rounded-2xl border border-dashed p-8 text-center text-gray-500">
        Revenue • Orders • Products • Customers • Payments • Refunds • GST/Tax • Sales by Shop • Sales by Category
      </div>
    </div>
  );
}
