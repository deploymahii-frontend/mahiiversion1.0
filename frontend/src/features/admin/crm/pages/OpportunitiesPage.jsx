      ...
      <div className="rounded-2xl bg-white shadow-sm p-6 flex justify-between items-center">
        ...
        <div>
          ...
          <p className="text-gray-500">
            Track business opportunities from qualification to deal closure.
          </p>
        ...
        <table className="w-full">
          ...
          <thead className="bg-gray-100">
            ...
            <tr>
              ...
              <th className="p-4 text-left">Expected Close</th>
            ...
            {opportunities.map((item) => (
              ...
              >
                ...
                <td className="p-4">
                  ...
                  <span className={`rounded-full px-3 py-1 text-sm ${getStageColor(item.stage)}`}>
                    {item.stage}
                  </span>
