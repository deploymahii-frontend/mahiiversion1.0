...
export default function LowStockAlerts({
  ...
  const cards = [
    ...
    },
    {
      ...
      value: overview.reorderRequired ?? 0,
    },
  ];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-2xl bg-white shadow-sm p-6 flex justify-between items-center">
        ...
        <div>
          ...
          <p className="text-gray-500">
            Monitor products that require replenishment before stock-outs occur.
          </p>
        </div>
        ...
        <table className="w-full">
          ...
          <thead className="bg-gray-100">
            ...
            <tr>
              ...
              <th className="p-4 text-left">Suggested Order</th>
          ...
          <tbody>
            ...
            {alerts.map((item) => (
              ...
              >
                ...
                <td className="p-4">{item.suggestedOrder}</td>
      ...
      <div className="rounded-2xl border border-dashed p-8 text-center text-gray-500">
        ...
        <FiBell className="mx-auto mb-3 text-2xl" />

        Critical Alerts → Procurement Recommendation → Purchase Order → Stock Replenishment
