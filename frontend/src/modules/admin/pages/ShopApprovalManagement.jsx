...
export default function ShopApprovalManagement() {
    ...
    const shops = data?.data?.docs || data?.data || [];
            ...
            <div className="mx-auto max-w-7xl px-5 py-8">
                <div className="mb-8 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                    <div>
                        ...
                        <p className="mt-2 text-gray-500">Manage all registered businesses on Mahii.</p>
                    </div>
                </div>
                    ...
                    <table className="min-w-full">
                        ...
                        <tbody>
                            {isLoading ? (
                                ...
                                <tr key={shop._id} className="border-b hover:bg-gray-50 transition-colors">
                                    <td className="p-4 font-medium">{shop.businessName}</td>
                                    <td className="p-4 text-gray-600">
                                      {shop.owner?.firstName} {shop.owner?.lastName}
                                      <div className="text-xs text-gray-400">{shop.owner?.email}</div>
                                    </td>
                                    <td className="p-4">{shop.category?.name || "N/A"}</td>
                                    <td className="p-4">
